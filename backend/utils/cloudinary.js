...
cloudinary.config({
  cloud_name: process.env.CLOUD_NAME || "dh9oodm3h" ,
  api_key: process.env.CLOUDINARY_API_KEY || "729296943644454",
  api_secret: process.env.CLOUDINARY_API_SECRET || "9-Ah7e5HsBf8kXMceun2GydEGlQ",
});
